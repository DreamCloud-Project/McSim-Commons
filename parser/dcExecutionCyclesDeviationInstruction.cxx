...
dcExecutionCyclesDeviationInstruction::dcExecutionCyclesDeviationInstruction(
		string NameIn) :
		dcInstruction(NameIn), LowerBound(0), UpperBound(0), RemainPromille(0), Mean(
				0), SD(0), Kappa(0), Lambda(0), LowerBoundValid(false), UpperBoundValid(
				false), RemainPromilleValid(false), MeanValid(false), SDValid(
				false), KappaValid(false), LambdaValid(false) {
}
...
void dcExecutionCyclesDeviationInstruction::SetRemainPromille(
		double RemainPromilleIn) {
