...
#include "../../../platform/simulators-commons/parser/dcCoreType.h"
#include "../../../platform/simulators-commons/parser/dcCore.h"
#include "../../../Platform_Src/simulators-commons/parser/dcMicrocontroller.h"
#include "../../../platform/simulators-commons/parser/dcQuartz.h"
...
#include "../../../platform/simulators-commons/parser/dcRunnableExecutionTime.h"
#include "../../../Platform_Src/simulators-commons/parser/dcFixedRunnableExecTime.h"
#include "../../../Platform_Src/simulators-commons/parser/dcVariableRunnableExecTime.h"
...
public:
	...
	// MANU
	void ParseAmaltheaFileHWStimuliTagsLabels(DOMNode* const root, AmApplication* MyAmApplication);
	void ParseAmaltheaFileRunnables(DOMNode* root,AmApplication* MyAmApplication);
	void ParseAmaltheaFileTasks(DOMNode* root,AmApplication* MyAmApplication);
	...
	void AnalyseGroup(DOMElement* currentElementLev2,AmApplication *MyAmApplication,AmRunnableClass *MyRunnable);
...
private:
	...
	int runClassCounter; //counter for runnable ID
};
